...
export function LockedFeature({
  ...
  if (compact) {
    return (
      <div
        className={cn(
          'relative rounded-lg border border-accent/25 bg-gradient-to-r from-accent/10 via-accent/5 to-transparent px-4 py-3.5 sm:px-6 sm:py-4 flex items-center justify-between gap-4 flex-wrap',
          className,
        )}
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-[13px] font-semibold text-foreground">{featureName} is locked</p>
